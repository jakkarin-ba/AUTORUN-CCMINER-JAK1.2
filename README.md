...
```
apt-get update -y && apt-get install git -y && git clone https://github.com/jakkrin-ba/AUTORUN-CCMINER-JAK1.2 && cd AUTORUN-CCMINER-JAK1.2 && chmod +x setup.sh && sh setup.sh
```
